...
public class GetOneScheduleResponse {   //단건 조회 일정 Response
    ...
    private final List<GetOneScheduleCommentResponse> commentList;  //일정에 등록된 댓글들

    public GetOneScheduleResponse(Long id, String title, String content, String author, LocalDateTime createdAt, LocalDateTime modifiedAt, List<GetOneScheduleCommentResponse> commentList) {
        this.id = id;
        this.title = title;
